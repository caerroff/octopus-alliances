...
export default function Topbar() {
    return (
        <>
            <div className="flex justify-center lg:justify-between bg-primary min-h-20 place-items-center px-5 p-1">
                <div className="px-5 lg:px-20 py-2">
                    <Image src={"/octopus.png"} className="rounded-2xl ml-2" height={110} width={110} alt="Octopus Logo" />
                </div>
