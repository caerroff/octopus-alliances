    ...
    return (
        <div className="min-h-20 bg-stone-800 flex flex-col justify-center px-5 text-white">
            ...
            <p>Octopus Alliances. It's all about you. We are building a dynamic global commerce ecosystem that will empower you as individuals, businesses, and
                ...
                More than just about business, Occy is built on shared values and a commitment to doing what is right, helping people and local communities. By providing
                cutting-edge technology, vital resources, and strategic guidance, Occy empowers a global network of people and communities to create a more just,
                sustainable, and connected future.</p>
